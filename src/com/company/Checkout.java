...
public class Checkout {
    ...
    public void nextInLine(Customer customer) {
        ...
        if(salesAction == SalesAction.NoAction) {
            discountCalculator.setDiscountStrategy(new NoSalesDiscount());
        } else if(salesAction == SalesAction.ChristmasEve) {
            discountCalculator.setDiscountStrategy(new ChristmasDiscount());
        } else if(salesAction == SalesAction.BlackFriday) {
            discountCalculator.setDiscountStrategy(new BlackFridayDiscount());
        }
